...
describe("BatchTransfer", function () {
  ...
  async function deployBatchTransfer() {
    ...
    await (await erc1155Token.mint(batchTransfer.address, 0, "10000000000000000")).wait()
    await (await erc20Token.mint(batchTransfer.address, ethers.BigNumber.from("10000000000000000"))).wait()
